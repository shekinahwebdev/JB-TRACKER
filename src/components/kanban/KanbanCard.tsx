...
const KanbanCard = () => {
  return (
    <div className="border-2  border-[rgb(var(--primary))] border-gray-300 bg-white text-orange-500 rounded px-4 py-2 w-full text-sm flex flex-col justify-center gap-1 transition hover:shadow-lg hover:-translate-y-0.5">
